...
declare -a file_to_check=("test_putchar_user_mode_result_expected.txt" "test_putString_user_mode_expect.txt" "test_putStringError_user_mode_expect.txt")

# la ligne de commande pour nachos
declare -a arguments=("./nachos-step2 -x ./putchar" "./nachos-step2 -x ./putString" "./nachos-step2 -x ./putStringError")

#le nom du test a affiché en cas d'échec
declare -a name_of_test=("Test putchar en user mode" "Test putString en user mode" "Test putString avec plus de charactére que taille buffer en user mode")
